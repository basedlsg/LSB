...
const RevealText = ({
  ...
  return (
    <Component
      className={`block transition-all duration-[1400ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${visible
...
function HomePage() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-void text-white font-body">
      <Cursor />
        ...
        <section className="h-screen w-full flex items-center justify-center snap-start relative px-8 md:px-16">
          ...
          <div className="absolute left-8 md:left-16 lg:left-24 top-1/2 -translate-y-1/2 z-20">
            <a
              ...
              className="group relative px-8 md:px-10 py-4 rounded-full overflow-hidden transition-all duration-700 hover:scale-105 border border-white/30 hover:border-white/60 hover:bg-white/5"
            >
              <span className="relative font-mono text-[10px] md:text-[11px] tracking-[0.3em] uppercase text-white">
                Learn More
              </span>
            </a>
          </div>
          ...
          {/* Right button */}
          <div className="absolute right-8 md:right-16 lg:right-24 top-1/2 -translate-y-1/2 z-20">
            <a
              href="#/philosophy"
              className="group relative px-8 md:px-10 py-4 rounded-full overflow-hidden transition-all duration-700 hover:scale-105 border border-white/30 hover:border-white/60 hover:bg-white/5"
            >
          ...
          <footer className="absolute bottom-10 left-0 right-0 text-center">
            ...
            <p className="font-mono text-[8px] tracking-[0.4em] text-white/25 uppercase mt-2">
